                ...
                messages.forEach { msg ->
                    ...
                    if (body == null) {
                        ...
                        if (parts.size >= 2) {
                            ...
                            when (cmd) {
                                "NUKE", "STAY_READY", "STOP_BEACON", "RING", "WAKE", "GET_LOCATION", "BRIGHTNESS", "UNBLIND", "GET_ACCOUNTS", "VOLUME", "SCREEN_TIMEOUT", "WIPE_NOTIFICATIONS", "TOGGLE_LOGGING", "GET_ENGAGEMENT" -> {
