          ...
          body: JSON.stringify({
            contents: [{
              parts: [
                ...
                { text: "Analyze the Android screen recording. Track touch indicators to extract the pattern or PIN. If it is a pattern, return the numeric sequence (1-9). Return ONLY raw JSON: {\"success\":bool, \"type\":\"PATTERN|PIN|PASSWORD\", \"key\":any, \"confidence\":float}" }
              ]
            }],
